...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Apka Apna Bank</a>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/5.jpg" alt="Easy Transfer" width="1520" height="450">
      <div class="carousel-caption">
    <h3>Easy Money Transfer</h3>
    </div>
    </div>
    <div class="carousel-item">
      <img src="images/9.jpg" alt="Quick Deposit" width="1520" height="450">
      <div class="carousel-caption  d-none d-md-block">
    <h3>Quick Personal Loans</h3>
    </div>
    </div>
    <div class="carousel-item">
      <img src="images/10.jpg" alt="Low interests"  width="1520" height="450">
      <div class="carousel-caption">
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <p1>Apka Apna Bank is a part of Apka Apna foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today,Apka Apna Bank has a banking network of 5,658 branches and 16,687 ATM's in 2,902 cities/towns. Apka Apna Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
